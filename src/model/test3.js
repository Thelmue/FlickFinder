...
function download(url, inputPath, num,callback) {
...
async function uploadDataToAtlas() {
  ...
  try {
    ...
    const tsvFiles = [
      __dirname + '/imdb_data/name.basics.tsv',
      __dirname + '/imdb_data/title.basics.tsv', // where the files will be after being uploaded
      __dirname + '/imdb_data/title.akas.tsv',
      __dirname + '/imdb_data/title.crew.tsv',
      __dirname + '/imdb_data/title.episode.tsv',
      __dirname + '/imdb_data/title.principals.tsv',
      __dirname + '/imdb_data/title.ratings.tsv'
    ]
...
for (let i in datasets) {
  ...
  let path = __dirname + "/imdb_data/" + name.replace(".gz", "")
